...
## Load the data
data_ = ""
with open('C:\\Users\\Andrew\\Documents\\telegram_history\\Hanna.txt', 'r', encoding="utf8") as f:
    data_ += f.read()
data_ = data_.lower()
print("done")

print("Converting to 1-hot")
...
if ckpt_file == "":
    ...
    for i in range(NUM_TRAIN_BATCHES):
        ...
        if (i % 100) == 0:
            saver.save(sess, "C:\development\pushkin-otdyhayet\lstm\tolstoy.txt")
            new_time = time.time()
    ...
    saver.save(sess, "C:\\development\\pushkin-takes-a-break\\lstm\\saved\\model.ckpt")
